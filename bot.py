...
admin=['ucc567d9c6215b4fc121546c8ac2ff47f','ubeca3aea12d7a5408407f7ccd8d909df','u7706b3684d2b36cbc96232cee6a99d48','u82e7e70a68995872301bfa0924f6140f','u1d67ba083955c09b286e66d897cfa408','u1704a32f6dca8dded24e4e358e90b03d',clMID]
msg_dict = {}
wait2 = {
    'readPoint':{},
    'readMember':{},
...
【Adminadd @】標註加入權限
【Admindel @】標註取消權限
【Adminadd:mid】使用系統識別碼將該用戶加入金庫 #
【Admindel:mid】使用系統識別碼將該用戶取消加入金庫 #
        ...
        if op.type == 11:
            ...
            if settings["qrprotect"] == True:
                if op.param2 in admin:
                    ...
                    cl.updateGroup(gs)
                    invsend = 0
                    cl.sendMessage(op.param1,cl.getContact(op.param2).displayName + "仁傑保護現金中i...不要動仁傑的錢！")
            ...
            if sender in admin:
                if msg.text in ["Help","help"]:
                  ...
                  if msg.toType == 2:
                    ...
                    start = time.time()
                    cl.sendMessage(to, "在算拉操你媽去轟幹煩死了......")
                    elapsed_time = time.time() - start
